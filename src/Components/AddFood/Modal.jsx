...
const Modal = () => {
  ...
  const onSubmit = async (data) => {
    ...
    if (IsPopular === false && IsRecommended === false) {
      ...
      between IsPopular & IsRecommended`,
        "error"
      );
    }
    const newItem = {
      ...
      <dialog id="my_modal_3" className="modal">
        <div className="modal-box bg-[#EEEFF0]">
          ...
          <form
            ...
            className="md:grid md:gap-6 gap-2 md:space-y-0 space-y-4 grid-cols-2 "
          >
            <div>
              <label
                htmlFor="Price"
            ...
            <div className="col-span-2 mt-6">
              {" "}
              <button type="submit" className="btn w-full btn-sm btn-neutral">
                Add Item
              </button>
            </div>
          </form>
